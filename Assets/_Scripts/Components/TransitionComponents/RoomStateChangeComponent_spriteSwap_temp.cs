...
/// <summary>
/// Component stores sprites of rooms and changes them depending on game stateTest
/// </summary>
public class RoomStateChangeComponent_spriteSwap_temp : MonoBehaviour
{
    ...
    {
        //get timeOfDay stateTest
        timeOfDay = TimeManagerRealTime_deprecated.Instance.timeOfDay;
